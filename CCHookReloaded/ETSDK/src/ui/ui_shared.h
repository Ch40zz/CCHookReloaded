...
typedef rectDef_t sdk_Rectangle;

// FIXME: do something to separate text vs window stuff
typedef struct {
	sdk_Rectangle rect;					// client coord sdk_Rectangle
	sdk_Rectangle rectClient;			// screen coord sdk_Rectangle
	const char *name;				//
	const char *model;				//
	...
	sdk_Rectangle rectEffects;			// for various effects
	sdk_Rectangle rectEffects2;			// for various effects
...
typedef struct itemDef_s {
	...
	sdk_Rectangle textRect;				// sdk_Rectangle the text ( if any ) consumes     
